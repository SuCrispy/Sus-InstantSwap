# Changelog (forge-26.2)

本文档记录 Sus-InstantSwap 在 `forge-26.2` 分支上的所有重要变更。
...
- 访问私有 Gui.screen：Forge 的 Access Transformer 不自动生效，改用 Mixin \`GuiAccessor\`（@Accessor）+ \`ScreenUtil\` 静态 helper
